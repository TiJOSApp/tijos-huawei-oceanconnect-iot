;(function($){
    ...
    function init() {
        ...
        $('body').append('<style>'+
            ...
            '.sel-box .btn{background:#45CEAC;overflow:hidden;}'+
            '.sel-box .btn1{overflow:hidden;float:left;padding:11px 12px;}'+
            '.sel-box .btn1 img{float:left;width:22px;height:22px;}'+
            ...
            '.sel-con .border{height:34px;border:solid 1px #45CEAC;border-width:1px 0;position:fixed;bottom:72px;left:0;right:0;pointer-events:none;}'+
